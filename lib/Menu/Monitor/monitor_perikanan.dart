...
class MonitorPerikanan extends StatefulWidget {
  @override
  _MonitorPerikananState createState() => _MonitorPerikananState();
}

class _MonitorPerikananState extends State<MonitorPerikanan> {
  @override
