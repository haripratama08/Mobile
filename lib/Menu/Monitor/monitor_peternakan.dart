...
class MonitorPeternakan extends StatefulWidget {
  @override
  _MonitorPeternakanState createState() => _MonitorPeternakanState();
}

class _MonitorPeternakanState extends State<MonitorPeternakan> {
  @override
