...
class MonitorIndoor2 extends StatefulWidget {
  final int ind;
  const MonitorIndoor2({Key key, this.ind});
  @override
...
class _MonitorIndoorState extends State<MonitorIndoor2> with Validation {
